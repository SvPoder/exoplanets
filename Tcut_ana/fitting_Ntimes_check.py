...
#lnprob(p0[0], robs, sigmarobs, Mobs, sigmaMobs, Aobs, sigmaAobs,
           #Tobs, sigmaTobs, Teff, points, values, a_interp, b_interp, c_interp, v)
