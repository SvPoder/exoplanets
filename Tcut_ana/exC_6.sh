...
python3.6 fitting_Ntimesb.py $ex $SLURM_ARRAY_TASK_ID $N $sigma2 0.6 20. $SLURM_JOB_ID
python3.6 fitting_Ntimesb.py $ex $SLURM_ARRAY_TASK_ID $N $sigma2 0.7 20. $SLURM_JOB_ID
python3.6 fitting_Ntimesb.py $ex $SLURM_ARRAY_TASK_ID $N $sigma2 0.8 20. $SLURM_JOB_ID
python3.6 fitting_Ntimesb.py $ex $SLURM_ARRAY_TASK_ID $N $sigma2 0.9 20. $SLURM_JOB_ID
python3.6 fitting_Ntimesb.py $ex $SLURM_ARRAY_TASK_ID $N $sigma2 0.8 10. $SLURM_JOB_ID
python3.6 fitting_Ntimesb.py $ex $SLURM_ARRAY_TASK_ID $N $sigma2 0.9 10. $SLURM_JOB_ID
