...
# EMCEE VERSION
def derivativeTDM_wrt_M_emcee(r, f, params, M, v=None, R=R_jup.value, Rsun=8.178,
                        epsilon=1, gNFW_rho = 0):
    """
    Return (analytical) derivative of DM temperature wrt mass @
    (f, gamma, rs, rho0, r, M, R) [K/Msun]
...
# EMCEE VERSION
def derivativeTDM_wrt_r_emcee(r, f, params, M, v=None, R=R_jup.value, Rsun=8.178,
                        epsilon=1, gNFW_rho = 0):
    """
    Return (analytical) derivative of DM temperature wrt r @
    (f, gamma, rs, rho0, r, M, R) [K/kpc]
