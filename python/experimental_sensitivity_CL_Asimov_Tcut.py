...
if __name__=="__main__":
    ...
    for i, _rs in enumerate(rs):
        ...
        gamma_up[i] = UL_at_rs(_rs, f, nBDs, relT, sigma, sigma, sigma, points,
                               ...
                               gamma_min=gamma_min[0], gamma_max=gamma_max[0])
    ...
    # save results
    np.savetxt("CUT_UL_" + ex + "_nBDs%i_f%.1f_steps%i_sigma%.1f_rs%.1fAsimov.dat"
